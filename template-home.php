...
get_header();?>
       ...
       <div id="preloader" class="preloader">
                        ...
                        <div class="header-main">
                            <div class="logo">
                                <a href="index.html" class="header-logo">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/logo/white-log.svg" alt="logo-img">
                                </a>
                                <div class="logo-2">
                                    <a href="index.html">
                                        <img src="<?php echo get_template_directory_uri();?>/assets/img/logo/black-logo.svg" alt="">
                                    </a>
                                </div>
                            </div>
                                                            ...
                                                            <div class="homemenu-items">
                                                                <div class="homemenu">
                                                                    <div class="homemenu-thumb">
                                                                        <img src="<?php echo get_template_directory_uri();?>/assets/img/header/home-1.jpg" alt="img">
                                                                ...
                                                                <div class="homemenu">
                                                                    <div class="homemenu-thumb mb-15">
                                                                        <img src="<?php echo get_template_directory_uri();?>/assets/img/header/home-2.jpg" alt="img">
                                                                        <div class="demo-button">
                                                                ...
                                                                <div class="homemenu">
                                                                    <div class="homemenu-thumb mb-15">
                                                                        <img src="<?php echo get_template_directory_uri();?>/assets/img/header/home-3.jpg" alt="img">
                                                                        <div class="demo-button">
            ...
            <div class="swiper hero-slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="hero-1">
                            <div class="hero-bg bg-cover" style="background-image: url(<?php echo get_template_directory_uri();?>/assets/img/hero/01.jpg);"></div>
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-10">
                                        <div class="hero-content">
                                            ...
                                            <div class="booking-list-area">
                                                <div class="booking-list">
                                                    <div class="icon">
                                                        <img src="<?php echo get_template_directory_uri();?>/assets/img/hero/icon-1.png" alt="img">
                                                    </div>
                                                    <div class="content">
                                                        <h6>Location</h6>
                                                        <div class="form">
                                                ...
                                                <div class="booking-list">
                                                    <div class="icon">
                                                        <img src="<?php echo get_template_directory_uri();?>/assets/img/hero/icon-2.png" alt="img">
                                                    </div>
                                                    <div class="content">
                                                ...
                                                <div class="booking-list">
                                                    <div class="icon">
                                                        <img src="<?php echo get_template_directory_uri();?>/assets/img/hero/icon-3.png" alt="img">
                                                    </div>
                                                    <div class="content">
                                                        <h6>Activate Day</h6>
                                                        <div class="form-clt">
                    ...
                    <div class="swiper-slide">
                        <div class="hero-1">
                            <div class="hero-bg bg-cover" style="background-image: url(<?php echo get_template_directory_uri();?>/assets/img/hero/02.jpg);"></div>
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-10">
                                        <div class="hero-content">
                    ...
                    <div class="swiper-slide">
                        <div class="hero-1">
                            <div class="hero-bg bg-cover" style="background-image: url(<?php echo get_template_directory_uri();?>/assets/img/hero/03.jpg);"></div>
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-10">
                                        <div class="hero-content">
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp wow" data-wow-delay=".2s">
                        <div class="feature-card-items">
                            <div class="icon">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/icon/01.svg" alt="img">
                            </div>
                            <div class="content">
                                <h3>
                                    A Lot of Discount
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp wow" data-wow-delay=".4s">
                        <div class="feature-card-items">
                            <div class="icon bg-color">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/icon/02.svg" alt="img">
                            </div>
                            <div class="content">
                                <h3>
                                    Best Guide
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp wow" data-wow-delay=".6s">
                        <div class="feature-card-items">
                            <div class="icon">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/icon/03.svg" alt="img">
                            </div>
                            <div class="content">
                                <h3>
                                    24/7 Support
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp wow" data-wow-delay=".8s">
                        <div class="feature-card-items">
                            <div class="icon">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/icon/04.svg" alt="img">
                            </div>
                            <div class="content">
                                <h3>
                                    Travel Management
        ...
        <!-- Destination-category Section Start -->
         <section class="destination-category-section section-padding pt-0">
            <div class="plane-shape float-bob-y">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/destination/shape.png" alt="img">
            </div>
            <div class="container">
                ...
                <div class="swiper category-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="destination-category-item">
                                <div class="category-image">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/destination/category1.jpg" alt="img">
                        ...
                        <div class="swiper-slide">
                            <div class="destination-category-item">
                                <div class="category-image">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/destination/category2.jpg" alt="img">
                                    <div class="category-content">
                                        <h5>
                                            <a href="destination-details.html">Adventure</a>
                                        </h5>
                        ...
                        <div class="swiper-slide">
                            <div class="destination-category-item">
                                <div class="category-image">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/destination/category3.jpg" alt="img">
                                    <div class="category-content">
                                        <h5>
                                            <a href="destination-details.html">Adventure</a>
                                        </h5>
                        ...
                        <div class="swiper-slide">
                            <div class="destination-category-item">
                                <div class="category-image">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/destination/category4.jpg" alt="img">
                                    <div class="category-content">
                                        <h5>
                                            <a href="destination-details.html">Adventure</a>
                                        </h5>
                        ...
                        <div class="swiper-slide">
                            <div class="destination-category-item">
                                <div class="category-image">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/destination/category5.jpg" alt="img">
                                    <div class="category-content">
                                        <h5>
                                            <a href="destination-details.html">Adventure</a>
                                        </h5>
        ...
        <!-- About Section Start -->
        <section class="about-section section-padding  fix bg-cover" style="background-image: url(<?php echo get_template_directory_uri();?>/assets/img/about/about-bg.jpg);">
                        ...
                        <div class="col-lg-6">
                            <div class="about-image">
                                ...
                                <div class="about-image-2">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/about/02.png" alt="img" class="wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.3s">
                                    <div class="plane-shape float-bob-y">
        ...
        <section class="cta-section section-padding">
            <div class="mobile-shape">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/mobile.png" alt="img">
            </div>
            <div class="container">
                <div class="row g-4">
                    <div class="col-lg-6 col-md-6 wow fadeInUp wow" data-wow-delay=".3s">
                        <div class="cta-items">
                            ...
                            <a href="tour-details.html" class="theme-btn">BOOK NOW <i class="fa-sharp fa-regular fa-arrow-right"></i></a>
                            <div class="cta-image">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/bag-shape.png" alt="img">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 wow fadeInUp wow" data-wow-delay=".5s">
                        <div class="cta-items style-2">
                            ...
                            <a href="tour-details.html" class="theme-btn">BOOK NOW <i class="fa-sharp fa-regular fa-arrow-right"></i></a>
                            <div class="cta-image">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/plane-shape.png" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="popular-destination-section section-padding pt-0">
            <div class="car-shape float-bob-x">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/destination/car.png" alt="img">
            </div>
            <div class="container">
                <div class="section-title-area justify-content-between">
                    ...
                    <a href="tour-details.html" class="theme-btn wow fadeInUp wow" data-wow-delay=".5s">View All Tour<i class="fa-sharp fa-regular fa-arrow-right"></i></a>
                </div> 
                <div class="row">
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp wow" data-wow-delay=".2s">
        ...
        <section class="deals-offer-section section-padding fix bg-cover" style="background-image: url(<?php echo get_template_directory_uri();?>/assets/img/offer/bg.jpg);">
            <div class="deals-offer-wrapper">
                <div class="row g-4">
                    <div class="col-lg-4">
                        <div class="price-items">
                            <div class="price-image wow fadeInUp wow" data-wow-delay=".2s">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/offer/price.png" alt="img">
                            </div>
                            ...
                            <div class="swiper offer-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="offer-items">
                                            <div class="offer-image">
                                                <img src="<?php echo get_template_directory_uri();?>/assets/img/offer/01.jpg" alt="img">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="offer-items">
                                            <div class="offer-image">
                                                <img src="<?php echo get_template_directory_uri();?>/assets/img/offer/02.jpg" alt="img">
                                                <div class="offer-content">
                                                    <ul class="offer-btn">
                                                        <li>-50% Off</li>
                                                    </ul>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="offer-items">
                                            <div class="offer-image">
                                                <img src="<?php echo get_template_directory_uri();?>/assets/img/offer/03.jpg" alt="img">
                                                <div class="offer-content">
                                                    <ul class="offer-btn">
                                                        <li>-50% Off</li>
                                                        <li class="bg-color">Featured</li>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="offer-items">
                                            <div class="offer-image">
                                               <img src="<?php echo get_template_directory_uri();?>/assets/img/offer/04.jpg" alt="img">
                                                <div class="offer-content">
                                                    <ul class="offer-btn">
                                                        <li>-50% Off</li>
                                                    </ul>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card-items style-2">
                                    ...
                                    <div class="client-info-items">
                                        ...
                                        <div class="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 45 45" fill="none">
                                                <path d="M21.5998 15.1662C21.4359 21.2706 20.2326 27.1028 17.1618 32.4687C15.0391 36.1766 11.8636 38.7708 8.31789 40.9881C8.09312 41.1284 7.80413 41.3886 7.55907 41.1588C7.2836 40.9002 7.52189 40.5673 7.66216 40.3087C8.9449 37.9646 10.3121 35.6645 11.4292 33.2309C12.6528 30.564 13.6212 27.811 14.2567 24.9396C14.4257 24.1774 14.255 24.0929 13.535 24.2484C7.64188 25.526 2.16112 21.8976 1.00852 15.9858C-0.0849304 10.38 3.84608 4.78603 9.51275 3.88694C15.9196 2.86954 21.5491 7.65063 21.5998 14.1522C21.6015 14.4902 21.5998 14.8282 21.5998 15.1662Z" fill="#1CA8CB"/>
                                                <path d="M44.25 15.2202C44.0793 21.5916 42.7949 27.6571 39.3912 33.1581C37.3175 36.5077 34.3228 38.8501 31.0746 40.9288C30.816 41.0945 30.4729 41.4375 30.1856 41.1198C29.9253 40.8325 30.2346 40.4877 30.3884 40.1987C31.6559 37.8462 33.0401 35.5562 34.1403 33.1142C35.3351 30.4642 36.2917 27.7382 36.9153 24.8939C37.0775 24.1536 36.8967 24.0827 36.2224 24.2415C30.2836 25.6358 24.4277 21.6338 23.5556 15.4348C22.7985 10.0537 26.7751 4.68115 32.1359 3.89022C38.7118 2.92353 44.2162 7.65053 44.25 14.2923C44.25 14.6016 44.25 14.9109 44.25 15.2202Z" fill="#1CA8CB"/>
                                              </svg>
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="travel-feature-section section-padding fix" style="background-image: url('<?php echo get_template_directory_uri();?>/assets/img/travel-bg.jpg');">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="feature-content">
                               ...
                               <a href="contact.html" class="theme-btn wow fadeInUp wow" data-wow-delay=".9s">Contact US<i class="fa-sharp fa-regular fa-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-6">
        ...
        <section class="team-section fix section-padding">
            <div class="jip-shape float-bob-x">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/team/jip.png" alt="img">
            </div>
            <div class="container">
                <div class="section-title text-center">
                    <span class="sub-title wow fadeInUp">
        ...
        <div class="brand-section section-padding pt-0">
            <div class="left-shape">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/brand/shape.png" alt="">
            </div>
            <div class="container">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="brand-image">
                                        <img src="<?php echo get_template_directory_uri();?>/assets/img/brand/01.png" alt="brand-img">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="brand-image">
