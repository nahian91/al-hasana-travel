                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-12 col-lg-8">
                        <div class="details-thumb">
                            <img src="<?php echo get_template_directory_uri();?>/assets/img/destails/tour-details.jpg" alt="img">
                            <ul class="image-list">
                                <li>
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/destails/tour-details-2.jpg" alt="img">
                                </li>
                                <li>
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/destails/tour-details-3.jpg" alt="img">
                                </li>
                                <li>
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/destails/tour-details-4.jpg" alt="img">
                                </li>
                            </ul>
                        </div>
                        <div class="activities-details-content">
                            <h2 class="mb-3">Ghorepani Poon Hill Trek</h2>
                            <p>
                            ...
                            <div class="activities-box-wrap">
                                <div class="activities-box-area">
                                    <div class="activities-box-item">
                                        <div class="icon">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/img/icon/27.svg" alt="img">
                                        </div>
                                        <div class="content">
                                            <span>
                                                Accommodation
                                    ...
                                    <div class="activities-box-item style-2">
                                        <div class="icon">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/img/icon/28.svg" alt="img">
                                        </div>
                                        <div class="content">
                                            <span>
                                                Admission Free
                                    ...
                                    <div class="activities-box-item">
                                        <div class="icon">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/img/icon/29.svg" alt="img">
                                        </div>
                                        <div class="content">
                                            <span>
                                                Arrival City
                                    ...
                                    <div class="activities-box-item">
                                        <div class="icon">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/img/icon/30.svg" alt="img">
                                        </div>
                                        <div class="content">
                                            <span>
                                                Language
                                ...
                                <div class="activities-box-area mb-0">
                                    <div class="activities-box-item">
                                        <div class="icon">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/img/icon/31.svg" alt="img">
                                        </div>
                                        <div class="content">
                                            <span>
                                                Hotel Transfer
                                    ...
                                    <div class="activities-box-item">
                                        <div class="icon">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/img/icon/32.svg" alt="img">
                                        </div>
                                        <div class="content">
                                            <span>
                                                Next Tour
                                    ...
                                    <div class="activities-box-item">
                                        <div class="icon">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/img/icon/33.svg" alt="img">
                                        </div>
                                        <div class="content">
                                            <span>
                                                01 Guide
                                    ...
                                    <div class="activities-box-item">
                                        <div class="icon">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/img/icon/34.svg" alt="img">
                                        </div>
                                        <div class="content">
                                            <span>
                                                Maximum Age
                                        ...
                                        <div class="accordion-item mb-3">
                                            ...
                                            <div id="faq1" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="faq-image">
                                                        <img src="<?php echo get_template_directory_uri();?>/assets/img/destails/faq-img.jpg" alt="img">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="cliect-review-area">
                                ...
                                <ul class="review-items">
                                    <li>
                                        <div class="thumb">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/img/destails/client-1.jpg" alt="img">
                                        </div>
                                        <div class="content">
                                            <div class="star">
                                    ...
                                    <li>
                                        <div class="thumb">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/img/destails/client-2.jpg" alt="img">
                                        </div>
                                        <div class="content">
                                            <div class="star">
                                                <i class="fa-solid fa-star"></i>
                                    ...
                                    <li>
                                        <div class="thumb">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/img/destails/client-3.jpg" alt="img">
                                        </div>
                                        <div class="content">
                                            <div class="star">
                                                <i class="fa-solid fa-star"></i>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="main-bar">
                            ...
                            <div class="booking-bg bg-cover"
                                style="background-image: url('<?php echo get_template_directory_uri();?>/assets/img/destails/booking-bg.jpg');">
                                <h3 class="text-title">
