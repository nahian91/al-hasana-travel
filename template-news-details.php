                        ...
                        <div class="blog-post-details">
                            <div class="single-blog-post">
                                <div class="post-featured-thumb bg-cover"
                                    style="background-image: url('<?php echo get_template_directory_uri();?>/assets/img/news/post-4.jpg');">
                                    <div class="post">
                                        <h3>
                                            16
                                            <span>Dec</span>
                                    ...
                                    <div class="row g-4">
                                        <div class="col-lg-6">
                                            <div class="details-image">
                                                <img src="<?php echo get_template_directory_uri();?>/assets/img/news/post-5.jpg" alt="img">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="details-image">
                                                <img src="<?php echo get_template_directory_uri();?>/assets/img/news/post-6.jpg" alt="img">
                                            </div>
                                        </div>
                                    </div>
                                    <p class="pt-4">
                            ...
                            <div class="comments-area">
                                ...
                                <div class="blog-single-comment d-flex gap-4 pt-4 pb-4">
                                    <div class="image">
                                        <img src="<?php echo get_template_directory_uri();?>/assets/img/news/comment.png" alt="image">
                                    </div>
                                    <div class="content">
                                        <div
                                ...
                                <div class="blog-single-comment d-flex gap-4 pt-5 pb-4">
                                    <div class="image">
                                        <img src="<?php echo get_template_directory_uri();?>/assets/img/news/comment-2.png" alt="image">
                                    </div>
                                    <div class="content">
                                        <div
                                            class="head d-flex flex-wrap gap-2 align-items-center justify-content-between">
                        ...
                        <div class="main-sideber">
                            ...
                            <div class="single-sidebar-widget">
                                ...
                                <div class="news-widget-categories">
                                    <ul>
                                        <li><a href="news-details.html">Travel</a><span>04</span></li>
                                        <li><a href="news-details.html">System</a><span>03</span></li>
                                        <li><a href="news-details.html">Agency</a><span>02</span></li>
                                        <li><a href="news-details.html">Restaurant</a><span>05</span></li>
                                        <li><a href="news-details.html">Rant A Car</a><span>06</span></li>
                                        <li><a href="news-details.html">Blueprint Builders</a><span>(03)</span></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="single-sidebar-widget">
                                ...
                                <div class="recent-post-area">
                                    <div class="recent-items">
                                        <div class="recent-thumb">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/img/news/pp1.jpg" alt="img">
                                        </div>
                                    ...
                                    <div class="recent-items">
                                        <div class="recent-thumb">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/img/news/pp2.jpg" alt="img">
                                        </div>
                                        <div class="recent-content">
                                            <ul>
                                                <li>
                                    ...
                                    <div class="recent-items">
                                        <div class="recent-thumb">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/img/news/pp3.jpg" alt="img">
                                        </div>
                                        <div class="recent-content">
                                            <ul>
                                                <li>
                            ...
                            <div class="single-sidebar-widget">
                                ...
                                <div class="news-widget-categories">
                                    <div class="tagcloud">
                                        ...
                                        <a href="news-details.html">World</a>
